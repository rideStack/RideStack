    ...
    <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:col-span-2 lg:grid-cols-3">
      <div>
        ...
        <p className="max-w-xs mt-4 text-gray-500">
          RideStack is not a real car website. These products are not real. This is a project made by Bobby Whitacre, Zeljko Maric and Ana Tran from the 2209-fbt-ct-web-pt cohort of FullStackAcademy.
        </p>
