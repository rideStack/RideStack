    ...
    <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:col-span-2 lg:grid-cols-3">
      <div>
        ...
        <p className="max-w-xs mt-4 text-gray-500">
          RideStack is not a real car website. These products are not real. This is a project made by Bobby Whitacre, Zeljko Maric and Ana Tran from the 2209-fbt-ct-web-pt cohort of FullStack Academy.
        </p>
      ...
      >
        ...
        <div>
          ...
          <nav aria-label="Footer Navigation - Company" className="mt-6">
            <ul className="space-y-4 text-sm">
              ...
              <li>
                <a href="https://bobby-whitacre.netlify.app/" className="text-gray-700 transition hover:opacity-75">
                  Portfolio
                </a>
              </li>
            </ul>
        ...
        <div>
          <p className="font-medium text-gray-900">Zeljko Maric</p>
